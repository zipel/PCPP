...
class Benchmark {
  public static void main(String[] args) {
	...
	switch(input){
		...
		case "5": 	Mark5();
					break;
		case "6":	Mark6("multiply", Benchmark::multiply);
					break;
		case "7":	Mark7("multiply", Benchmark::multiply);
					break;
		case"math":	MathFunctionBenchmarks();
					break;
		case "8":	final java.util.Random rnd = new java.util.Random();
    				final int n = 1638400;
    				Mark8("random_index", i -> rnd.nextInt(n));
					break;
		case "9":SearchBenchmarks();
					break;
		case "10":SearchScalabilityBenchmarks1();
					break;
		case "11":SearchScalabilityBenchmarks2();
					break;
		case "12":GetPseudorandomItems();
					break;
		case "13":SortingBenchmarks();
					break;
		case "14":SortingScalabilityBenchmarks();
					break;
